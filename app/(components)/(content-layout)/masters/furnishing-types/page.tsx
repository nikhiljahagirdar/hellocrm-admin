...
const FurnishingTypes = () => {
  ...
  const furnishingData = [
    { id: 1, furnishingLevel: 'Unfurnished', description: 'No furniture provided', status: 'Active', createdDate: '2024-01-15', updatedDate: '2024-01-15' },
    { id: 2, furnishingLevel: 'Semi', description: 'Partially furnished', status: 'Active', createdDate: '2024-01-14', updatedDate: '2024-01-14' },
    { id: 3, furnishingLevel: 'Full', description: 'Fully furnished', status: 'Active', createdDate: '2024-01-13', updatedDate: '2024-01-13' },
    { id: 4, furnishingLevel: 'Luxury', description: 'Premium furnished', status: 'Inactive', createdDate: '2024-01-12', updatedDate: '2024-01-12' },
    { id: 5, furnishingLevel: 'Basic', description: 'Basic furniture only', status: 'Active', createdDate: '2024-01-11', updatedDate: '2024-01-11' }
  ]
  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Furnishing Types</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item"><a href="#!">Masters</a></li>
              <li className="breadcrumb-item active">Furnishing Types</li>
            </ol>
          </nav>
        </div>
      </div>
            ...
            <Card.Body className="p-0">
              <div className="table-responsive">
                <SpkTables
                  ...
                  showCheckbox={true}
                  header={[
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('furnishingLevel')} style={{cursor: 'pointer'}}>Furnishing Level <i className="ri-arrow-up-down-line ms-1"></i></div> },
                ...
                >
                  {furnishingData.map((furnishing, index) => (
                    <tr key={index}>
                      <td><input className="form-check-input" type="checkbox" /></td>
                      <td>
                        <SpkBadge variant="" Customclass={`badge bg-${furnishing.furnishingLevel === 'Unfurnished' ? 'secondary' : furnishing.furnishingLevel === 'Semi' ? 'warning' : 'success'}-transparent`}>
                          {furnishing.furnishingLevel}
                        </SpkBadge>
                      </td>
                      <td>{furnishing.description}</td>
                      <td>
                        <SpkBadge variant="" Customclass={`badge bg-${furnishing.status === 'Active' ? 'success' : 'danger'}-transparent`}>
                          {furnishing.status}
                        </SpkBadge>
                      </td>
                      <td>{furnishing.createdDate}</td>
                      <td>{furnishing.updatedDate}</td>
                      <td>
