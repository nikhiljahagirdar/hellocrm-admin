...
const LeadSources = () => {
  ...
  const leadSourcesData = [
    { id: 1, businessName: 'ABC Properties', sourceName: 'Website', description: 'Leads from company website', status: 'Active', createdDate: '2024-01-15', updatedDate: '2024-01-15' },
    { id: 2, businessName: 'XYZ Builders', sourceName: 'Facebook', description: 'Social media leads', status: 'Active', createdDate: '2024-01-14', updatedDate: '2024-01-14' },
    { id: 3, businessName: 'PQR Realty', sourceName: 'Google Ads', description: 'Paid advertising leads', status: 'Active', createdDate: '2024-01-13', updatedDate: '2024-01-13' },
    { id: 4, businessName: 'ABC Properties', sourceName: 'Referral', description: 'Customer referral leads', status: 'Inactive', createdDate: '2024-01-12', updatedDate: '2024-01-12' },
    { id: 5, businessName: 'LMN Developers', sourceName: 'Walk-in', description: 'Direct walk-in leads', status: 'Active', createdDate: '2024-01-11', updatedDate: '2024-01-11' }
  ]
  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Lead Sources</h1>
        </div>
              ...
              <div className="d-flex align-items-center justify-content-between w-100">
                <div className="d-flex align-items-center gap-2">
                  <div className="d-flex flex-wrap gap-3 align-items-center">
                    ...
                    <Form.Control type="text" placeholder="Source Name" className="form-control-sm" style={{ width: '200px' }} />
              ...
              <div className="table-responsive">
                <SpkTables
                  ...
                  header={[
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('sourceName')} style={{cursor: 'pointer'}}>Source Name <i className="ri-arrow-up-down-line ms-1"></i></div> },
                ...
                >
                  {leadSourcesData.map((source, index) => (
                    <tr key={index}>
                      ...
                      <td className="fw-semibold">{source.businessName}</td>
                      <td>
                      ...
                      <td>
                        <SpkBadge variant="" Customclass={`badge bg-${source.status === 'Active' ? 'success' : 'danger'}-transparent`}>
                          {source.status}
                        </SpkBadge>
                      </td>
