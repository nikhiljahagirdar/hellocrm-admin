...
const LeadTags = () => {
  ...
  const leadTagsData = [
    { id: 1, businessName: 'ABC Properties', tagName: 'Hot Lead', description: 'High priority lead', color: '#dc3545', status: 'Active', createdDate: '2024-01-15', updatedDate: '2024-01-15' },
    { id: 2, businessName: 'XYZ Builders', tagName: 'Cold Lead', description: 'Low priority lead', color: '#6c757d', status: 'Active', createdDate: '2024-01-14', updatedDate: '2024-01-14' },
    { id: 3, businessName: 'PQR Realty', tagName: 'VIP', description: 'VIP customer lead', color: '#ffc107', status: 'Active', createdDate: '2024-01-13', updatedDate: '2024-01-13' },
    { id: 4, businessName: 'ABC Properties', tagName: 'Follow Up', description: 'Requires follow up', color: '#17a2b8', status: 'Inactive', createdDate: '2024-01-12', updatedDate: '2024-01-12' },
    { id: 5, businessName: 'LMN Developers', tagName: 'Interested', description: 'Showing interest', color: '#28a745', status: 'Active', createdDate: '2024-01-11', updatedDate: '2024-01-11' }
  ]
  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Lead Tags</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item active">Lead Tags</li>
            </ol>
          </nav>
        </div>
      </div>
                ...
                >
                  {leadTagsData.map((tag, index) => (
                    <tr key={index}>
                      ...
                      <td className="fw-semibold">{tag.businessName}</td>
                      <td>
