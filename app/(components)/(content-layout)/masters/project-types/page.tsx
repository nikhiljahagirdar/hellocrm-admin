...
const ProjectTypes: React.FC<ProjectTypesProps> = () => {
  ...
  const projectTypesData = [
    { id: 1, typeName: 'Residential', description: 'Residential properties and projects', status: 'Active', createdDate: '2024-01-15', updatedDate: '2024-01-15' },
    { id: 2, typeName: 'Commercial', description: 'Commercial properties and projects', status: 'Active', createdDate: '2024-01-14', updatedDate: '2024-01-14' },
    { id: 3, typeName: 'Industrial', description: 'Industrial properties and projects', status: 'Active', createdDate: '2024-01-13', updatedDate: '2024-01-13' },
    { id: 4, typeName: 'Mixed Use', description: 'Mixed use development projects', status: 'Inactive', createdDate: '2024-01-12', updatedDate: '2024-01-12' },
    { id: 5, typeName: 'Retail', description: 'Retail spaces and shopping centers', status: 'Active', createdDate: '2024-01-11', updatedDate: '2024-01-11' }
  ]
  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Project Types</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item active">Project Types</li>
            </ol>
          </nav>
        </div>
      </div>
            ...
            <Card.Header>
              <div className="d-flex align-items-center justify-content-between w-100">
                ...
                <div className="d-flex flex-wrap gap-3 align-items-center">
                  <Form.Control type="text" placeholder="Type Name" className="form-control-sm" style={{ width: '200px' }} />
            ...
            <Card.Body className="p-0">
              <div className="table-responsive">
                <SpkTables
                  ...
                  showCheckbox={true}
                  header={[
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('typeName')} style={{cursor: 'pointer'}}>Type Name <i className="ri-arrow-up-down-line ms-1"></i></div> },
                ...
                >
                  {projectTypesData.map((type, index) => (
                    <tr key={index}>
                      <td><input className="form-check-input" type="checkbox" /></td>
                      <td className="fw-semibold">{type.typeName}</td>
