...
const MessageCreditTypes = () => {
  ...
  const creditTypesData = [
    { id: 1, creditType: 'SMS Credits', description: 'Credits for SMS messaging', unitCost: '₹0.50', maxUnits: '10000', status: 'Active', createdDate: '2024-01-15', updatedDate: '2024-01-15' },
    { id: 2, creditType: 'Email Credits', description: 'Credits for email messaging', unitCost: '₹0.10', maxUnits: '50000', status: 'Active', createdDate: '2024-01-14', updatedDate: '2024-01-14' },
    { id: 3, creditType: 'WhatsApp Credits', description: 'Credits for WhatsApp messaging', unitCost: '₹1.00', maxUnits: '5000', status: 'Active', createdDate: '2024-01-13', updatedDate: '2024-01-13' },
    { id: 4, creditType: 'Voice Credits', description: 'Credits for voice calls', unitCost: '₹2.00', maxUnits: '2000', status: 'Inactive', createdDate: '2024-01-12', updatedDate: '2024-01-12' },
    { id: 5, creditType: 'Push Notification Credits', description: 'Credits for push notifications', unitCost: '₹0.05', maxUnits: '100000', status: 'Active', createdDate: '2024-01-11', updatedDate: '2024-01-11' }
  ]
        ...
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item active">Message Credit Types</li>
            </ol>
          </nav>
        </div>
      </div>
                ...
                <div className="d-flex align-items-center gap-2">
                  <div className="d-flex flex-wrap gap-3 align-items-center">
                    <Form.Select className="form-select-sm" style={{ width: '180px' }}>
                      ...
                      <option>Voice Credits</option>
                      <option>Push Notification Credits</option>
                    </Form.Select>
              ...
              <div className="table-responsive">
                <SpkTables
                  ...
                  header={[
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('maxUnits')} style={{cursor: 'pointer'}}>Max Units <i className="ri-arrow-up-down-line ms-1"></i></div> },
                ...
                >
                  {creditTypesData.map((creditType, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        <SpkBadge variant="" Customclass={`badge bg-${creditType.creditType.includes('SMS') ? 'primary' : creditType.creditType.includes('Email') ? 'success' : creditType.creditType.includes('WhatsApp') ? 'warning' : 'info'}-transparent`}>
                          {creditType.creditType}
                        </SpkBadge>
                      </td>
                      <td>{creditType.description}</td>
                      <td className="text-success fw-semibold">{creditType.unitCost}</td>
                      <td className="text-primary fw-semibold">{creditType.maxUnits}</td>
                      <td>
                        <SpkBadge variant="" Customclass={`badge bg-${creditType.status === 'Active' ? 'success' : 'danger'}-transparent`}>
                          {creditType.status}
                        </SpkBadge>
                      </td>
                      <td>
