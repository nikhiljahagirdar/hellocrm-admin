...
const ProjectAuthorities = () => {
  ...
  const authoritiesData = [
    { id: 1, authorityName: 'RERA', description: 'Real Estate Regulatory Authority', status: 'Active', createdDate: '2024-01-15', updatedDate: '2024-01-15' },
    { id: 2, authorityName: 'Municipal Corporation', description: 'Local Municipal Authority', status: 'Active', createdDate: '2024-01-14', updatedDate: '2024-01-14' },
    { id: 3, authorityName: 'Development Authority', description: 'Urban Development Authority', status: 'Active', createdDate: '2024-01-13', updatedDate: '2024-01-13' },
    { id: 4, authorityName: 'Pollution Control Board', description: 'Environmental Authority', status: 'Inactive', createdDate: '2024-01-12', updatedDate: '2024-01-12' },
    { id: 5, authorityName: 'Fire Department', description: 'Fire Safety Authority', status: 'Active', createdDate: '2024-01-11', updatedDate: '2024-01-11' }
  ]
  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Project Authorities</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item"><a href="#!">Masters</a></li>
              <li className="breadcrumb-item active">Project Authorities</li>
            </ol>
          </nav>
        </div>
      </div>
              ...
              <div className="d-flex align-items-center justify-content-between w-100">
                <div className="d-flex align-items-center gap-2">
                  <div className="d-flex flex-wrap gap-3 align-items-center">
                    <Form.Control type="text" placeholder="Authority Name" className="form-control-sm" style={{ width: '200px' }} />
            ...
            <Card.Body className="p-0">
              <div className="table-responsive">
                <SpkTables
                  ...
                  showCheckbox={true}
                  header={[
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('authorityName')} style={{cursor: 'pointer'}}>Authority Name <i className="ri-arrow-up-down-line ms-1"></i></div> },
                ...
                >
                  {authoritiesData.map((authority, index) => (
                    <tr key={index}>
                      ...
                      <td className="fw-semibold">{authority.authorityName}</td>
                      <td>{authority.description}</td>
                      <td>
                        <SpkBadge variant="" Customclass={`badge bg-${authority.status === 'Active' ? 'success' : 'danger'}-transparent`}>
                          {authority.status}
                        </SpkBadge>
                      </td>
                      <td>{authority.createdDate}</td>
                      <td>{authority.updatedDate}</td>
                      <td>
