...
const ImpersonationLogs: React.FC<ImpersonationLogsProps> = () => {
  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Impersonation Logs</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item"><a href="#!">Businesses</a></li>
              <li className="breadcrumb-item active">Impersonation Logs</li>
            </ol>
          </nav>
        </div>
      </div>
