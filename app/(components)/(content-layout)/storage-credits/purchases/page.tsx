...
interface StorageCreditsPurchasesProps {}

const StorageCreditsPurchases: React.FC<StorageCreditsPurchasesProps> = () => {
  ...
  const purchasesData = [
    { id: 1, business: 'ABC Properties', plan: 'Professional Plan', amount: '₹2,999', credits: '100GB', purchaseDate: '2024-01-15', paymentStatus: 'Completed', transactionId: 'TXN001' },
    { id: 2, business: 'XYZ Builders', plan: 'Enterprise Plan', amount: '₹9,999', credits: '1TB', purchaseDate: '2024-01-14', paymentStatus: 'Completed', transactionId: 'TXN002' },
    { id: 3, business: 'PQR Realty', plan: 'Basic Plan', amount: '₹999', credits: '10GB', purchaseDate: '2024-01-13', paymentStatus: 'Pending', transactionId: 'TXN003' },
    { id: 4, business: 'LMN Developers', plan: 'Premium Plan', amount: '₹4,999', credits: '500GB', purchaseDate: '2024-01-12', paymentStatus: 'Completed', transactionId: 'TXN004' },
    { id: 5, business: 'RST Holdings', plan: 'Professional Plan', amount: '₹2,999', credits: '100GB', purchaseDate: '2024-01-11', paymentStatus: 'Failed', transactionId: 'TXN005' }
  ]
  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Storage Credits Purchases</h1>
        </div>
              ...
              <div className="table-responsive">
                <SpkTables
                  ...
                  header={[
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('plan')} style={{cursor: 'pointer'}}>Plan <i className="ri-arrow-up-down-line ms-1"></i></div> },
...
export default StorageCreditsPurchases